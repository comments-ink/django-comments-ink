...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('reaction', django_comments_ink.models.ReactionField(db_index=True, verbose_name='reaction')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reaction', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='django_comments_ink.commentreaction')),
            ],
        ),
        migrations.AddField(
            model_name='commentreaction',
            name='authors',
            field=models.ManyToManyField(through='django_comments_ink.CommentReactionAuthor', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='commentreaction',
            name='comment',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reactions', to='django_comments_ink.inkcomment', verbose_name='reactions'),
        ),
    ]
